...
function getUserPwd(user, pwd) {
	// 通过 rsa 加密获取加密后的 user 和 pwd
	setMaxDigits(130);

	// RSAKeyPair 的参数可能会改变，根据实际网站可以自行调整
	...
	UserPwd[0] = encryptedString(key, user);
	UserPwd[1] = encryptedString(key, pwd);
	return UserPwd;
}